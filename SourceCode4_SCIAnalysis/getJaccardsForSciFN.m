function [allShuffledDataOut, actualDataActiveCellDistancesOut] = getJaccardsForSciFN(cellDistancesInput, ...
    within_frames_to_analyze_trimmedInput, XY_coords_arrayInput, paddedSignalPeaksInput, ...
    micronsPerPixelInput, numShufflesInput)
...
allShuffledDataOut = cell(1, numShufflesInput);
tic;
for shuffle=1:numShufflesInput
